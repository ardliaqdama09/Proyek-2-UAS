...
import org.aplas.lms.adapters.students.AttendanceCourseAdapter;
...
public class StudentAttendanceActivity extends AppCompatActivity {
    ...
    private AttendanceCourseAdapter attendanceCourseAdapter;
    ...
    private void getCourse() {
        ...
        Call<ArrayList<CourseResponse>> call = apiService.get_all_course();
        call.enqueue(new Callback<ArrayList<CourseResponse>>() {
            ...
            public void onResponse(Call<ArrayList<CourseResponse>> call, Response<ArrayList<CourseResponse>> response) {
                if(response.code() == 200){
                    ...
                    attendanceCourseAdapter = new AttendanceCourseAdapter(getApplicationContext(), courseArrayList);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(StudentAttendanceActivity.this);
                    rv_course.setLayoutManager(layoutManager);
                    rv_course.setAdapter(attendanceCourseAdapter);
