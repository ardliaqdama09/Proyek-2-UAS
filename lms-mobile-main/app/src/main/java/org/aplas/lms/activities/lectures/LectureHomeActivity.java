    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cv_matkul.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LectureHomeActivity.this, LectureCourseActivity.class);
        ...
        call.enqueue(new Callback<LogoutResponse>() {
            ...
            public void onResponse(Call<LogoutResponse> call, Response<LogoutResponse> response) {
                ...
                if(response.code() == 201 && logoutResponse.getStatus()){
                    ...
                    Toast.makeText(LectureHomeActivity.this, "User logout fail!", Toast.LENGTH_SHORT).show();
                }
